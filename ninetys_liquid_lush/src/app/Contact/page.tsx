        ...
        <div className="flex flex-col p-20">
          <div className="flex flex-row pb-10 w-full">
            ...
            <div className="w-1/2">
              ...
              <p className="font-medium text-base">
                You can follow us on social media, leave comments, see what
          ...
          <div className="flex flex-row pb-10">
            ...
            <div className="w-1/2">
              ...
              <p className="font-medium text-base">
                ...
                mobile app, any one of our services or with the customer
                service. We are always looking to improve and welcome your
                feedback.
              </p>
            </div>
          </div>
