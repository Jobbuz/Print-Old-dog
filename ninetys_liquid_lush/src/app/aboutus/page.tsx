        ...
        <div>
            ...
            <div className="align-top flex flex-row px-10">
                <div className="ml-10 w-[70vw]">
                    <h1 className={`inline-block bg-clip-text bg-gradient-to-r from-[#219C90] to-[#B029DB] mt-20 mb-8 text-4xl text-transparent ${leckerli_one.className}`}>
                        {text1}
                    </h1>
                    <p className="mb-20 pr-20 pb-16 text-s">{text2}</p> </div>
                <div className="flex flex-col justify-center mr-20 ml-20 text-center">
                    <Image src={"/aboutus2.png"} height={294} width={284} className="w-41 h-41 self-center" alt={''}></Image>
                    <p className="mt-2 font-Alata font-bold text-center text-xl">{text3}</p>
